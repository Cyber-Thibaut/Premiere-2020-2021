...
def start(): # Lance le jeu
    try: para = menu("SNAKE", "Lancer la partie", ["Mode","Classique","Dingue"], ["Difficulté","Moyen","Difficile"," Extrême","Facile"], ["Bordures","Mortelles","  Téléportation"], ["Commandes"," Nav: Flèches","Menu: HOME","Rejouer: OK"])
