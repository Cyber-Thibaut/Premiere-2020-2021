...
date=str(input("Quelle est la date du jour (jj/mm/aaaa)"))

parametres = ("Jouer","Niveau","Vision","Grille","Tibo")
options = (0,(1,110,47),(0,1,2,3),(0,1),0)
reglages = ["",1,2,0,""]
...
def engine():
    ...
    print("Tu as perdu au niveau",str(gl[0]),"avec",str(gl[1]),"ligne(s)\net un score de",str(gl[2]),"(le",date,")")
    getKey()
    gl = [1, 0, 0]
    fill_rect(77, 11, 168, 210, (248, 252, 248))
    fill_rect(248, 0, 72, 222, (248, 252, 248))
nav()
#Tu as perdu au niveau 43 avec 71 ligne(s) et un score de 187161 (le 12/01/2021)
#Tu as perdu au niveau 46 avec 77 ligne(s) et un score de 208827 (le 20/01/2021)
